<aside class="sidebar">
    ...
    <nav>
        <ul>
            ...
            <?php if (!$es_chofer): ?>
            <li class="<?php echo ($pagina_actual === 'folleteria') ? 'activo' : ''; ?>"><a href="<?php echo BASE_URL; ?>modulos/folleteria/listar.php">Documentos Médicos (Admin) <span class="badge">Mód. 1</span></a></li>
            <?php endif; ?>
            <li class="<?php echo ($pagina_actual === 'folleto_publico') ? 'activo' : ''; ?>"><a href="<?php echo BASE_URL; ?>modulos/folleto_publico/ver.php">Documento QR (Paciente)</a></li>
